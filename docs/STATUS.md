...
- **S25-S27 — runtime optimisation:** fixed-storage telemetry, compile-time-disabled instrumentation, generic latency hysteresis governor, crossover auto-calibration and explicit tuner/control-overhead cheapness gate.

## Not yet claimed

No target-hardware crossover, bot integration, ladder-runtime speedup, behavioural equivalence or V1 release certification is claimed yet. Those require the later deep-test, benchmark/profile/output and hardening slices plus representative consumer evidence.
